...
interface AdminRepository {
    ...
    suspend fun deleteAllCarts(): Result<Unit>
    ...
    suspend fun populateSampleProducts(): Result<Unit>
    ...
    suspend fun uploadProducts(products: List<Map<String, String>>): Result<Int>
    suspend fun uploadCategories(categories: List<Map<String, String>>): Result<Int>
}
